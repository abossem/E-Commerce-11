      ...
      <div>
        <div className="bg-white p-8 rounded border border-gray-100 max-w-[500px]">
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <input type="email" name="email" value={formik.values.email} onChange={formik.handleChange} onBlur={formik.handleBlur}  className="w-full border-1 rounded p-2 mb-4 " />
          ...
          {accountError && (
            ...
            <input type="password" name="password" value={formik.values.password} onChange={formik.handleChange} onBlur={formik.handleBlur} className="w-full border-1 rounded p-2 mb-4 " />
            {formik.errors.password && formik.touched.password && (
            <p className="text-red-400 mt-1 text-sm">*{formik.errors.password}</p>
          )}

<button type="submit" className="w-full cursor-pointer bg-yellow-500 text-white py-2 rounded">
            Log in
          </button>
          </form>
