...
import payments from '../../assets/sprite-map.png'

export default function OrderMethods ()
{
  return <div className="flex-1 bg-white lg:p-5">
    <button className="lg:hidden w-full py-3 rounded-4xl bg-amber-300">Contineue</button>
    ...
    <div className="lg:m-3 lg:p-5 lg:border border-[#cecece] flex flex-col gap-5">
      ...
      <div>
        ...
        <div className="lg:mt-3 border-[#cecece] border lg:border-none p-4 lg:p-0 rounded-2xl flex flex-col lg:flex-row items-center gap-3">
          ...
          <img src={payments} className="+h-[50px]" alt="" />
      ...
      <div>
        ...
        <p className="ml-8 mt-1 text-sm">Pay by cash on delivery. Non-refundable COD fees of <b>EGP 12</b> may apply.</p>
      </div>
    </div>
  </div>;
}